concrete AdventureEng of Adventure = open AdventureResEng, Prelude in {
  lincat
    Utt = {s : Str} ;
...
lin blue_A = mkA "blue" ;
lin bluewhale_N = mkN "blue whale" ;
lin boat_N = mkN "boat" ;
lin book_N = mkN "book" ;
lin boy_N = mkN "boy" ;
...
lin cold_A = mkA "cold" ;
lin consume_V = mkV "consume" ;
lin consume_V2 = mkV2 (mkV "consume" "consumed" "consumed") ;
lin come_V = mkV "come" "came" "come" ;
lin computer_N = mkN "computer" ;
lin cow_N = mkN "cow" ;
lin delicious_A = mkA "delicious" ;
...
lin egg_N = mkN "egg" ;
lin elephantseal_N = mkN "elephant seal" ;
lin emperorpenguin_N = mkN "emperor penguin" ;
lin fat_A = mkA "fat" ;
...
lin kingpenguin_N = mkN "king penguin" ;
-- lin know_VS = mkVS (mkV "know" "knew" "known") ;
lin lake_N = mkN "lake" ;
lin language_N = mkN "language" ;
lin leopardseal_N = mkN "leopard seal" ;
lin live_V = mkV "live" ;
